...
* Requirements:
	Simple_shell is designed to run on Ubuntu 14.04 LTS linux environment and it is compliled using GNU compiler `gcc` with the flags `-Wall, -We	rror, -Wextra and -pedantic`
...
* Contents:
	README.md - Contains the descriptive text and light documentations of all the datails of this simple_shell program.
